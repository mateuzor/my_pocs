// 🐈 Cat facts from https://catfact.ninja/
...
export default [
  ...
  {
    fact: "Relative to its body size, the clouded leopard has the biggest canines of all animals 2019 canines. Its dagger-like teeth can be as long as 1.8 inches (4.5 cm).",
    length: 156,
  },
  {
  ...
  {
    fact: "The ability of a cat to find its way home is called cpsi-traveling. Experts think cats either use the angle of the sunlight to find their way or that cats have magnetized cells in their brains that act as compasses.",
    length: 216,
  },
  {
  ...
  {
    fact: "Cats should not be fed tuna exclusively, as it lacks taurine, an essential nutrient required for good feline health.  Make sure you have the proper Pet supplies to keep your cat happy and healthy.",
    length: 196,
  },
  {
  ...
  {
    fact: "Cats have 30 teeth (12 incisors, 10 premolars, 4 canines, and 4 molars), while dogs have 42. Kittens have baby teeth, which are replaced by permanent teeth around the age of 7 months.",
    length: 183,
  },
  {
  ...
  {
    fact: "The Cat Fanciers Association (CFA) recognizes 44 breeds of cats.",
    length: 64,
  },
  ...
  {
    fact: "Neutering a male cat will, in almost all cases, stop him from spraying (territorial marking), fighting with other males (at least over females), as well as lengthen his life and improve its quality.",
    length: 198,
  },
  ...
  {
    fact: "Of all the species of cats, the domestic cat is the only species able to hold its tail vertically while walking. All species of wild cats hold their tail horizontally or tucked between their legs while walking.",
    length: 210,
  },
  ...
  {
    fact: 'Edward Lear, author of \\The Owl and the Pussycat\\"", is said to have had his new house in San Remo built to exactly the same specification as his previous residence, so that his much-loved tabby, Foss, would immediately feel at home."""',
    length: 236,
  },
  {
  ...
  {
    fact: "Cats do not think that they are little people. They think that we are big cats. This influences their behavior in many ways.",
    length: 124,
  },
  ...
  {
    fact: 'The Ancient Egyptian word for cat was mau, which means "to see".',
    length: 64,
  },
  {
  ...
  {
    fact: 'When your cats rubs up against you, she is actually marking you as \\hers\\" with her scent. If your cat pushes his face against your head"',
    length: 137,
  },
  {
  ...
  {
    fact: "Owning a cat is actually proven to be beneficial for your health.",
    length: 65,
  },
  ...
  {
    fact: "Your cat's heart beats at a rate almost double that of yours, from 110-140 beats per minute.",
    length: 92,
  },
  {
  ...
  {
    fact: "When a domestic cat goes after mice, about 1 pounce in 3 results in a catch.",
    length: 76,
  },
  {
  ...
  {
    fact: "A cat\u2019s eyesight is both better and worse than humans. It is better because cats can see in much dimmer light and they have a wider peripheral view. It\u2019s worse because they don\u2019t see color as well as humans do. Scientists believe grass appears red to cats.",
    length: 256,
  },
  {
  ...
  {
    fact: "Cats often overract to unexpected stimuli because of their extremely sensitive nervous system.",
    length: 94,
  },
  {
