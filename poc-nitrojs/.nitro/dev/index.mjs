...
import destr from 'file:///Users/mateuzor/Projects/my_pocs/poc-nitrojs/node_modules/destr/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestURL, getRequestHeader, getResponseHeader, getRequestHeaders, setResponseHeaders, setResponseStatus, send, appendResponseHeader, removeResponseHeader, createError, setResponseHeader, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getQuery as getQuery$1 } from 'file:///Users/mateuzor/Projects/my_pocs/poc-nitrojs/node_modules/h3/dist/index.mjs';
import { createHooks } from 'file:///Users/mateuzor/Projects/my_pocs/poc-nitrojs/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/mateuzor/Projects/my_pocs/poc-nitrojs/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/mateuzor/Projects/my_pocs/poc-nitrojs/node_modules/node-mock-http/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, decodePath, withLeadingSlash, withoutTrailingSlash } from 'file:///Users/mateuzor/Projects/my_pocs/poc-nitrojs/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/mateuzor/Projects/my_pocs/poc-nitrojs/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/mateuzor/Projects/my_pocs/poc-nitrojs/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/mateuzor/Projects/my_pocs/poc-nitrojs/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/mateuzor/Projects/my_pocs/poc-nitrojs/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/mateuzor/Projects/my_pocs/poc-nitrojs/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/mateuzor/Projects/my_pocs/poc-nitrojs/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/mateuzor/Projects/my_pocs/poc-nitrojs/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/mateuzor/Projects/my_pocs/poc-nitrojs/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import { resolve, dirname, join } from 'node:path';
import consola from 'file:///Users/mateuzor/Projects/my_pocs/poc-nitrojs/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/mateuzor/Projects/my_pocs/poc-nitrojs/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/mateuzor/Projects/my_pocs/poc-nitrojs/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/mateuzor/Projects/my_pocs/poc-nitrojs/node_modules/source-map/source-map.js';
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mateuzor/Projects/my_pocs/poc-nitrojs"}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/mateuzor/Projects/my_pocs/poc-nitrojs/server"}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mateuzor/Projects/my_pocs/poc-nitrojs/.nitro"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/mateuzor/Projects/my_pocs/poc-nitrojs/.nitro/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/mateuzor/Projects/my_pocs/poc-nitrojs/.data/kv"}));
...
const _qhLbpj = eventHandler((event) => {
...
const _lazy_VRki9L = () => Promise.resolve().then(function () { return _id__delete$1; });
const _lazy_7BW053 = () => Promise.resolve().then(function () { return _id__get$1; });
const _lazy_hryM4m = () => Promise.resolve().then(function () { return _id__patch$1; });
...
const handlers = [
  ...
  { route: '/todos/:id', handler: _lazy_VRki9L, lazy: true, middleware: false, method: "delete" },
  { route: '/todos/:id', handler: _lazy_7BW053, lazy: true, middleware: false, method: "get" },
  { route: '/todos/:id', handler: _lazy_hryM4m, lazy: true, middleware: false, method: "patch" }
];
...
const index = defineEventHandler(() => ({ message: "Nitro Todos API", endpoints: ["/todos"] }));
...
const todos_get$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: todos_get
});
